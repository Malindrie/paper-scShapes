...
save(result, file = "pbmc3k/n5000/result.rds")
...
save(result_KS, file = "pbmc3k/n5000/result_KS.rds")
...
save(result_BIC, file = "pbmc3k/n5000/result_BIC.rds")
...
save(result_pval, file = "pbmc3k/n5000/result_pval.rds")
