...
save(result, file = "pbmc3k/n2638/result.rds")
...
save(result_KS, file = "pbmc3k/n2638/result_KS.rds")
...
save(result_BIC, file = "pbmc3k/n2638/result_BIC.rds")
...
save(result_pval, file = "pbmc3k/n2638/result_pval.rds")
